...
#if QT_CONFIG(quick_path)
QV4::ReturnedValue QCanvasJSContext2D::method_get_path(const QV4::FunctionObject *b, const QV4::Value *thisObject, const QV4::Value *, int)
{
    QV4::Scope scope(b);
    QV4::Scoped<QCanvasJSContext2D> r(scope, *thisObject);
    CHECK_CONTEXT(r)
...
QV4::ReturnedValue QCanvasJSContext2D::method_set_path(const QV4::FunctionObject *b, const QV4::Value *thisObject, const QV4::Value *argv, int argc)
{
    QV4::Scope scope(b);
    QV4::Scoped<QCanvasJSContext2D> r(scope, *thisObject);
    CHECK_CONTEXT(r)
...
/*!
  \qmlmethod object Canvas2DContext::fill()
   ...
   \sa fillStyle
  */
QV4::ReturnedValue QCanvasJSContext2DPrototype::method_fill(const QV4::FunctionObject *b, const QV4::Value *thisObject, const QV4::Value *, int)
{
    QV4::Scope scope(b);
    QV4::Scoped<QCanvasJSContext2D> r(scope, *thisObject);
    CHECK_CONTEXT(r);
 ...
 */
QV4::ReturnedValue QCanvasJSContext2DPrototype::method_stroke(const QV4::FunctionObject *b, const QV4::Value *thisObject, const QV4::Value *, int)
{
    QV4::Scope scope(b);
    QV4::Scoped<QCanvasJSContext2D> r(scope, *thisObject);
    CHECK_CONTEXT(r)
...
#if QT_CONFIG(quick_path)
    proto->defineAccessorProperty(QStringLiteral("path"), QCanvasJSContext2D::method_get_path, QCanvasJSContext2D::method_set_path);
#endif
