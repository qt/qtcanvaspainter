...
void EventItemRenderer::synchronize(QQuickCPainterItem *item)
{
...
void EventItemRenderer::paint(QCPainter *p)
{
    ...
    for (int i=0 ; i<m_items.count() ; i++)
    {
        ...
        QColor fillColor(isPressed ? 0xFFFF0000 : isActive ? 0xFFFFFFFF : 0xFF000000);
        ...
        p->setFillStyle(QColor::fromRgba(isResizable ? 0x80F0F0F0 : 0x00F0F0F0));
